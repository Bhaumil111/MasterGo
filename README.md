...
- [ ] Goroutine lifecycle
- [ ] Goroutine stack (small → grows)

### Internals (VERY IMPORTANT)
- [ ] Go scheduler overview
- [ ] G-M-P model (Goroutine, Machine, Processor)
- [ ] Work stealing
- [ ] Preemption (Go 1.14+)
- [ ] Blocking syscalls & scheduler behavior
...
## 2️ Memory Model & Safety (Most People Skip — Don’t)

- [ ] Go memory model basics
- [ ] Happens-before relationship
- [ ] Visibility guarantees
- [ ] Why data races are bugs (not “sometimes ok”)
- [ ] Stack vs heap in concurrent programs

> 👉 This explains why the race detector works
...
## 8️ Testing & Debugging Concurrency
...
## 9 Performance & Observability (Senior Level)

- [ ] Profiling concurrent code (`pprof`)
- [ ] Blocking profile
...
##  10 Real-World Failure Patterns (Must Know)
